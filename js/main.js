...
// ─── Boot log messages ────────────────────────────────────────────
const BOOT_LOG = [
  '[  OK  ] Booting AleXim Mobile...',
  '[  OK  ] Initializing ARM64 kernel...',
  '[  OK  ] Mounting encrypted storage...',
  '[  OK  ] Starting mobile network stack...',
  '[  OK  ] Loading security layer...',
  '[  OK  ] Decrypting user profile...',
  '[  OK  ] Starting UI compositor...',
  '[  OK  ] Applying app sandbox isolation...',
  '[  OK  ] Loading anonymization layer...',
  '[  OK  ] AleXim Mobile — ready.',
];
...
async function init() {
  ...
  if (termWin?.terminal && typeof GameLoop !== 'undefined') {
    ...
    if (isNewGame) {
      ...
      t.printHTML(`  <span style="color:var(--text-muted)">Sistema:       </span><span style="color:var(--text-normal)">AleXim Mobile v2.4.1</span>`);
