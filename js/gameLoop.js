...
const GameLoop = (() => {
  ...
  function _registerCommands(t) {
    ...
    t.commands['help'] = {
      ...
      handler(args, t) {
        t.printBlank();
        t.printHTML(`<span style="color:var(--cyan);font-family:var(--font-hud);letter-spacing:2px;">AleXim Mobile — COMANDOS DISPONIBLES</span>`);
    ...
    t.registerCommand('tools', (args, t) => {
      ...
      t.printHTML(
        `<span style="color:var(--text-dim)">` +
        `Abrí la app "Tools" (icono ⚙ en la pantalla de inicio) para comprar más herramientas.` +
        `</span>`
      );
    ...
    t.registerCommand('whoami', (args, t) => {
      ...
      t.printHTML(
        ...
        `<span style="color:var(--text-dim)"> @ </span>` +
        `<span style="color:var(--cyan)">AleXim Mobile 2.4.1</span>`
      );
      t.printHTML(
    ...
    t.registerCommand('agents', (args, t) => {
      ...
      t.printBlank();
      t.printHTML(`<span style="color:var(--text-dim)">→ Abrí Threat Monitor en la pantalla de inicio para el panel completo.</span>`);
