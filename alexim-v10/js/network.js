...
window.NetworkSystem = (() => {
  ...
  const LEGACY_NEWS = [
    ...
    {id:'n05',time:'08:20',tag:'TECH',   title:'Se filtran fragmentos del kernel de AleXim OS 2.5',body:'Código fuente parcial publicado en foros privados del underground.'},
  ];
